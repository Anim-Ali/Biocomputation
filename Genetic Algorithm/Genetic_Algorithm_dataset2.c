...
void main() {
    ...
    data_file = fopen("Results/data2_results.txt", "w");
...
void load_data() {
   ...
   temp = (data){.variables = {0, 0, 0, 0, 0, 1}, .class = 1};
   data_set[1] = temp;

   temp = (data){.variables = {0, 0, 0, 0, 1, 0}, .class = 0};
   data_set[2] = temp;

   temp = (data){.variables = {0, 0, 0, 0, 1, 1}, .class = 1};
   data_set[3] = temp;
   ...
   temp = (data){.variables = {0, 0, 1, 0, 0, 1}, .class = 1};
   data_set[9] = temp;

   temp = (data){.variables = {0, 0, 1, 0, 1, 0}, .class = 0};
   data_set[10] = temp;

   temp = (data){.variables = {0, 0, 1, 0, 1, 1}, .class = 1};
   data_set[11] = temp;
   ...
   temp = (data){.variables = {0, 1, 0, 0, 0, 0}, .class = 0};
   data_set[16] = temp;
   ...
   temp = (data){.variables = {0, 1, 0, 0, 1, 1}, .class = 1};
   data_set[19] = temp;

   temp = (data){.variables = {0, 1, 0, 1, 0, 0}, .class = 0};
   data_set[20] = temp;

   temp = (data){.variables = {0, 1, 0, 1, 0, 1}, .class = 0};
   data_set[21] = temp;
   ...
   temp = (data){.variables = {0, 1, 1, 0, 0, 0}, .class = 0};
   data_set[24] = temp;
   ...
   temp = (data){.variables = {0, 1, 1, 0, 1, 1}, .class = 1};
   data_set[27] = temp;

   temp = (data){.variables = {0, 1, 1, 1, 0, 0}, .class = 0};
   data_set[28] = temp;

   temp = (data){.variables = {0, 1, 1, 1, 0, 1}, .class = 0};
   data_set[29] = temp;
   ...
   temp = (data){.variables = {1, 0, 0, 0, 1, 1}, .class = 0};
   data_set[35] = temp;

   temp = (data){.variables = {1, 0, 0, 1, 0, 0}, .class = 1};
   data_set[36] = temp;

   temp = (data){.variables = {1, 0, 0, 1, 0, 1}, .class = 1};
   data_set[37] = temp;

   temp = (data){.variables = {1, 0, 0, 1, 1, 0}, .class = 1};
   data_set[38] = temp;

   temp = (data){.variables = {1, 0, 0, 1, 1, 1}, .class = 1};
   data_set[39] = temp;

   temp = (data){.variables = {1, 0, 1, 0, 0, 0}, .class = 0};
   data_set[40] = temp;

   temp = (data){.variables = {1, 0, 1, 0, 0, 1}, .class = 0};
   data_set[41] = temp;

   temp = (data){.variables = {1, 0, 1, 0, 1, 0}, .class = 0};
   data_set[42] = temp;

   temp = (data){.variables = {1, 0, 1, 0, 1, 1}, .class = 0};
   data_set[43] = temp;

   temp = (data){.variables = {1, 0, 1, 1, 0, 0}, .class = 1};
   data_set[44] = temp;

   temp = (data){.variables = {1, 0, 1, 1, 0, 1}, .class = 1};
   data_set[45] = temp;
   ...
   temp = (data){.variables = {1, 1, 0, 0, 1, 1}, .class = 0};
   data_set[51] = temp;
   ...
   temp = (data){.variables = {1, 1, 0, 1, 1, 1}, .class = 0};
   data_set[55] = temp;

   temp = (data){.variables = {1, 1, 1, 0, 0, 0}, .class = 1};
   data_set[56] = temp;

   temp = (data){.variables = {1, 1, 1, 0, 0, 1}, .class = 1};
   data_set[57] = temp;
   ...
   temp = (data){.variables = {1, 1, 1, 1, 0, 1}, .class = 1};
   data_set[61] = temp;
